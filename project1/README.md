...
dev.off()
```
![](https://github.com/thanhlt7/coursera2020/blob/master/project1/plot1.png)
```R
library("data.table")
...
dev.off()
```
![](https://github.com/thanhlt7/coursera2020/blob/master/project1/plot2.png)
```R
library("data.table")
...
dev.off()
```
![](https://github.com/thanhlt7/coursera2020/blob/master/project1/plot3.png)
```R
library("data.table")
...
dev.off()
```
![](https://github.com/thanhlt7/coursera2020/blob/master/project1/plot4.png)
